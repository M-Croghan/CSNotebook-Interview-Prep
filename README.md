...
:ballot_box_with_check: [What is Angular?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-is-angular)  
:ballot_box_with_check: [What is a SPA?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-is-a-spa)  
:ballot_box_with_check: [What are decorators in Angular? ](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-are-decorators-in-angular)  
:ballot_box_with_check: [What are Templates in Angular?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-are-templates-in-angular)  
:ballot_box_with_check: [What are Annotations in Angular?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-are-annotations-in-angular)  
:ballot_box_with_check: [What are Directives in Angular?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-are-directives-in-angular)  
:ballot_box_with_check: [What are Components in Angular?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-are-components-in-angular)  
:ballot_box_with_check: [What are pipes?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-are-pipes)  
:ballot_box_with_check: [What is an ngModule?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-is-an-ngmodule)  
:ballot_box_with_check: [What are Services in Angular?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-are-services-in-angular)  
:ballot_box_with_check: [What are Promises?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-are-promises)  
:ballot_box_with_check: [What are Observables?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-are-observables)  
:ballot_box_with_check: [What is ngOnInit? How is it defined? ](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-is-ngoninit-how-is-it-defined)  
:ballot_box_with_check: [How is ngFor used in a tag?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-how-is-ngfor-used-in-a-tag)  
:ballot_box_with_check: [What is Bootstrap? How is it embedded into Angular? ](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-is-bootstrap-how-is-it-embedded-into-angular)  
:ballot_box_with_check: [What are the biggest advantages of using Angular?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-are-the-biggest-advantages-of-using-angular--)  
:ballot_box_with_check: [What is the package.json file?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-is-the-packagejson-file)  
:ballot_box_with_check: [What is a Module in Angular?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-is-a-module-in-angular)   
:ballot_box_with_check: [What is the observable pattern?](https://github.com/M-Croghan/CSNotebook-Interview-Prep/blob/main/angular.md#a-what-is-the-observable-pattern)  
